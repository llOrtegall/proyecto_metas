...
import { MesActMultired, MesActServired } from "../types/mesActi"
...
function parsearInfoArrayMultired(data: MesActMultired){
  const ASTRO = {
    id: 1,
    producto: 'Astro',
...
function parsearInfoArrayServired(data: MesActServired){
  const ASTRO = {
    id: 1,
    producto: 'Astro',
    ventaActual: data.EJE_ASTRO,
