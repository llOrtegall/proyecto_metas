...
const navLinks = [
  { id: 1, path: '/resumen', icon: Dashboard, label: 'Resumen De Aspiración' },
  ...
  { id: 5, path: '/sugeridos', icon: DocsIcon, label: 'Sugeridos' },
  { id: 6, path: '/historial', icon: DocsIcon, label: 'Historial Categorias' }
]
